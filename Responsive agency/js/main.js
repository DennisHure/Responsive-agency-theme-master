...
var server = http.createServer(function(req,res){
    res.setHeader('content-type-options',"script-src 'self'")
    res.setHeader('content-security-policy', "script-src 'self' https://apis.google.com; style-src 'self'")
    res.setHeader('X-Xss-Protection', "script-src 'self'" )
    res.setHeader('X-Content-Type-Options', "script-src 'self'" )
    res.setHeader('X-Frame-Options', "script-src 'self'" )
  ...
  Configure(IApplicationBuilderapp, IWebHostEnvironmentenv)
        {
